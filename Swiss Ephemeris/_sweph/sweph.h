...
/* moon, s. moshmoon.c */
int swi_mean_node(double jd, double *x, char *serr);
int swi_mean_apog(double jd, double *x, char *serr);
int swi_moshmoon(double tjd, AS_BOOL do_save, double *xpm, char *serr) ;
int swi_moshmoon2(double jd, double *x);
